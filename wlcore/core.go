...
//
// Package wlcore contains generated definitions of Wayland protocols.
//
...
type XdgWmBase struct{ wlclient.Proxy }

func (*XdgWmBase) Interface() *wlproto.Interface { return xdgWmBaseInterface }

func (obj *XdgWmBase) WithQueue(queue *wlclient.EventQueue) *XdgWmBase {
	wobj := &XdgWmBase{}
	obj.Conn().NewWrapper(obj, wobj, queue)
	return wobj
}
...
type XdgPositioner struct{ wlclient.Proxy }

func (*XdgPositioner) Interface() *wlproto.Interface { return xdgPositionerInterface }

func (obj *XdgPositioner) WithQueue(queue *wlclient.EventQueue) *XdgPositioner {
	wobj := &XdgPositioner{}
	obj.Conn().NewWrapper(obj, wobj, queue)
	return wobj
}
...
type XdgSurface struct{ wlclient.Proxy }

func (*XdgSurface) Interface() *wlproto.Interface { return xdgSurfaceInterface }

func (obj *XdgSurface) WithQueue(queue *wlclient.EventQueue) *XdgSurface {
	wobj := &XdgSurface{}
	obj.Conn().NewWrapper(obj, wobj, queue)
	return wobj
}
...
type XdgToplevel struct{ wlclient.Proxy }

func (*XdgToplevel) Interface() *wlproto.Interface { return xdgToplevelInterface }

func (obj *XdgToplevel) WithQueue(queue *wlclient.EventQueue) *XdgToplevel {
	wobj := &XdgToplevel{}
	obj.Conn().NewWrapper(obj, wobj, queue)
	return wobj
}
...
type XdgPopup struct{ wlclient.Proxy }

func (*XdgPopup) Interface() *wlproto.Interface { return xdgPopupInterface }

func (obj *XdgPopup) WithQueue(queue *wlclient.EventQueue) *XdgPopup {
	wobj := &XdgPopup{}
	obj.Conn().NewWrapper(obj, wobj, queue)
	return wobj
}
